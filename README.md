...
bootc-based Fedora image for varuniyer.net. Runs the website, WebDAV, and a Postgres 18 instance for experiments. All three are plain system services from Fedora packages.
